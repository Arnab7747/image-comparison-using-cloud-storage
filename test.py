...
# except:
#     print("no extra resource present\n")
...
#                     ssim_similarity = float(clean_SSIM(image_test,test_image_path))
#                     orb_similarity = float(clean_ORB(image_test,test_image_path))
...
maxvalID_phash,maxvalID_ssim,maxvalID_orb="","",""
maxval_phash_list,maxval_ssim_list,maxval_orb_list=[],[],[]
test_phash_list,test_ssim_list,test_orb_list=[],[],[]
    ...
    for test_image in Crops:
        ...
        for doc in docs:
            ...
            if(obj['imgID'].__contains__(Class)):
                ...
                test_phash_list.append({test_image:[obj['imgID'],phash_similarity]})
